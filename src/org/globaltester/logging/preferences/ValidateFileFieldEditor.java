 ...
 */
public class ValidateFileFieldEditor extends FileFieldEditor {
     ...
     */
    protected ValidateFileFieldEditor() {
    }
     ...
     */
    public ValidateFileFieldEditor(String name, String labelText, Composite parent) {
     ...
     * @param parent the parent of the field editor's control
     */
    public ValidateFileFieldEditor(String name, String labelText, boolean enforceAbsolute, Composite parent) {
        this(name, labelText, enforceAbsolute, VALIDATE_ON_KEY_STROKE, parent);
    }
    /**
     * Creates a file field editor.
     * 
     ...
     */
    public ValidateFileFieldEditor(String name, String labelText,
